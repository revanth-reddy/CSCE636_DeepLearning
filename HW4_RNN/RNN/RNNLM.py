...
class Config(object):
  ...
  max_epochs = 40 # the number of max epoch
  early_stopping = 2
  dropout = 0.1
  lr = 0.01
  vocab_size= 0
...
def test_RNNLM():
  ...
  base_path = "/content/drive/MyDrive/CSCE636/Assignments/CSCE636_DeepLearning/HW4_RNN/RNN/"
  ...
  for epoch in range(config.max_epochs):
    ...
    if valid_pp < best_val_pp:
      ...
      torch.save(state, base_path + './ckpt.pth')
  ...
  checkpoint = torch.load( base_path + './ckpt.pth')
